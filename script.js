...
facebookIcon.onmouseenter = function () {
  facebookIcon.innerHTML = `<path
...
instagramIcon.onmouseenter = function () {
  instagramIcon.innerHTML = `<path
